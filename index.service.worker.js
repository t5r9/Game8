...
/** @type {string} */
const CACHE_VERSION = '1762890921|19660094568';
/** @type {string} */
const CACHE_PREFIX = 'Game8-sw-cache-';
...
/** @type {string[]} */
const CACHEABLE_FILES = ["index.wasm","index.pck","index.side.wasm","libdd3d.web.template_release.wasm32.wasm"];
